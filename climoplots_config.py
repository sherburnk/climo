...
elems_rec = {'maxtmp': {'id': 'maxtmp', 'title': 'Record High Daily Max Temperature', 
                    'unit': 'degrees', 'label': 'Temperature (Fahrenheit)', 'val': 1, 'col': 'b',
                    'reclab': 'Max'},
         'mintmp': {'id': 'mintmp', 'title': 'Record Low Daily Min Temperature',
                    'unit': 'degrees', 'label': 'Temperature (Fahrenheit)', 'val': 2, 'col': 'r',
                    'reclab': 'Min'},
         'hmntmp': {'id': 'hmntmp', 'title': 'Record High Daily Min Temperature',
                    'unit': 'degrees', 'label': 'Temperature (Fahrenheit)', 'val': 2, 'col': 'b',
                    'reclab': 'High Min'},
         'lmxtmp': {'id': 'lmxtmp', 'title': 'Record Low Daily Max Temperature',
         ...
         'maxsnw': {'id': 'maxsnw', 'title': 'Record High Daily Snowfall',
                    ...
                    'reclab': 'Snowfall'},
         'maxavg': {'id': 'maxavg', 'title': 'Record High Daily Avg Temperature',
                    'unit': 'degrees', 'label': 'Temperature (Fahrenheit)', 'val': 5, 'col': 'r',
                    'reclab': 'High Avg'},
         'minavg': {'id': 'minavg', 'title': 'Record Low Daily Avg Temperature',
...
elems_avg = {'avgmax': {'id': 'avgmax', 'title': 'Average Daily Max Temperature', 
                    'unit': 'degrees', 'label': 'Temperature (Fahrenheit)', 
                    'dfile': 'dly-tmax-normal.txt', 'mfile': 'mly-tmax-normal.txt',
                    'col': 'b', 'aname': 'maxt'},
         'avgmin': {'id': 'avgmin', 'title': 'Average Daily Min Temperature',
                    'unit': 'degrees', 'label': 'Temperature (Fahrenheit)', 
                    'dfile': 'dly-tmin-normal.txt', 'mfile': 'mly-tmin-normal.txt',
                    'col': 'r', 'aname': 'mint'},
         'avgavg': {'id': 'avgavg', 'title': 'Average Daily Mean Temperature',
                    'unit': 'degrees', 'label': 'Temperature (Fahrenheit)', 
